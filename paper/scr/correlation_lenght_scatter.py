...
df_log_length = pd.DataFrame({'Matern': np.log(np.array(df_matern["len_scale"])),
                              'Stable': np.log(np.array(df_stable["len_scale"])),
                              'Gauss': np.log(np.array(df_gauss["len_scale"])),
                              'Exp': np.log(np.array(df_exp["len_scale"])),
                              'Sph': np.log(np.array(df_sph["len_scale"]))})
